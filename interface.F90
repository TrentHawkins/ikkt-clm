...
#     include "precision.F90"
      ...
      module interface
            ...
            character(500),public::base_file_name
            character(500),public::seed_file_name
            character(500),public::time_file_name
            character(500),public::conf_file_name

            real(KK),public::time_setting= .00000e+0
            real(KK),public::average_step= .10000e-4
            real(KK),public::   time_skip= .10000e-4
