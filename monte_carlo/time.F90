...
#     include "monte_carlo/average.F90"
      ...
      module time_type
            ...
            type::time(precision)
               ...
               real(precision),private::opening_time=+.00000e+0
      ...
      contains
            ...
            subroutine make_time_K(this,time_setting,average_step)
                 ...
                 =this%current_time
                  this%closing_time&
                 =this%opening_time+time_setting
            ...
            subroutine  read_time_K(dtv,unit,iotype,v_list,iostat,iomsg)
                  ...
                  if(iotype=='listdirected') then
                      ...
                      read(unit=unit,fmt=format_time_K,iostat=iostat,iomsg=iomsg,advance='no') dtv%current_time
                                                                                               dtv%opening_time&
                                                                                              =dtv%current_time
                      read(unit=unit,fmt=format_time_K,iostat=iostat,iomsg=iomsg,advance='no')
                      read(unit=unit,fmt=format_time_K,iostat=iostat,iomsg=iomsg,advance='no')
            ...
            subroutine  read_dynamic_time_K(dtv,unit,iotype,v_list,iostat,iomsg)
                  ...
                  if(iotype=='listdirected') then
                      ...
                      read(unit=unit,fmt=format_time_K,iostat=iostat,iomsg=iomsg,advance='no') dtv%current_step
                                                                                               dtv%opening_time&
                                                                                       =weight(dtv%log_average_control)
            !                                                                                  dtv%log_current_control&
            !                                                                                 =dtv%log_average_control
